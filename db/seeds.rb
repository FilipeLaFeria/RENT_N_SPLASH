...
pool_2.photo.attach(io: file_2, filename: 'salt_j5zent.jpg', content_type: 'image/jpg')

file_3 = URI.open('https://res.cloudinary.com/dhyx17ztf/image/upload/v1622544682/jacuzzi_mkkdgm.jpg')
pool_3 = Pool.create!(title: "Hot like Jacuzzi", address: "Avenida da Liberdade, Lisboa", description: "Perfect to chill with bubbles", size: '10 m2', user_id: filipe.id)
...
pool_4.photo.attach(io: file_4, filename: 'ocean_uqnmir.jpg', content_type: 'image/jpg')
...
pool_5.photo.attach(io: file_5, filename: 'ocean_uqnmir.jpg', content_type: 'image/jpg')
...
pool_6.photo.attach(io: file_6, filename: 'ocean_uqnmir.jpg', content_type: 'image/jpg')
...
pool_7.photo.attach(io: file_7, filename: 'ocean_uqnmir.jpg', content_type: 'image/jpg')
...
pool_8.photo.attach(io: file_8, filename: 'ocean_uqnmir.jpg', content_type: 'image/jpg')
