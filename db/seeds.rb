...
pool_1 = Pool.create!(title: "Great for swimming", address: "Avenida Marginal, Lisboa", description: "Huge pool for professional swimmers to train", size: '200', user_id: jacome.id)
...
pool_2 = Pool.create!(title: "Salty", address: "Carvalhal, Zambujeira do Mar", description: "Green salt water pool", size: '45', user_id: aura.id)
...
pool_3 = Pool.create!(title: "Hot like Jacuzzi", address: "Avenida da Liberdade, Lisboa", description: "Perfect to chill with bubbles", size: '10', user_id: aura.id)
...
pool_4 = Pool.create!(title: "Ocean's view", address: "Furnas do Guincho, Cascais", description: "Pool by the ocean with infinite view", size: '30', user_id: joao.id)
...
pool_5 = Pool.create!(title: "Beach side", address: "Costa da Caparica, Setúbal", description: "The best of both sides: a pool and a beach", size: '20', user_id: joao.id)
...
pool_6 = Pool.create!(title: "Our pateo pool", address: "Santa Catarina, Sines", description: "A pool for all our guests", size: '50', user_id: joao.id)
...
pool_7 = Pool.create!(title: "Rooftop pool", address: "Marquês de Pombal, Lisboa", description: "Dive at the top of the city", size: '20', user_id: jacome.id)
...
pool_8 = Pool.create!(title: "Lake dive", address: "Bacelo, Évora", description: "A dive and multiple activities in it", size: '400', user_id: joao.id)
...
pool_9 = Pool.create!(title: "Bio Pool", address: "Ericeira", description: "Dip on our natural pool", size: '200', user_id: aura.id)
